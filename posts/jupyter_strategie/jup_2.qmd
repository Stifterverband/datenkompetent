...
::: column-margin
![Beispiel für die farbliche Gestaltung eines Abschnitts, hier in Grün für einen Arbeitsauftrag](abb1.svg){#fig-abb1}
:::
...
::: column.body
![Beispiel für die Integration unterschiedlicher interaktiver Elemente](abb2.svg){#fig-abb2}
:::

Bei Multiple-Choice-Fragen ist eine automatische Rückmeldung möglich (@fig-abb3). 

::: column.body
![Beispiel für eine Multiple-Choice-Frage](abb3.svg){#fig-abb3}
:::
