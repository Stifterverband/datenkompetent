...
description: 'Im Fokus des Beitrags steht das (digitale) Storytelling, das als didaktische Herangehensweise die narrative Vermittlung von (Erfahrungs-)Wissen adressiert (Thier 2017). Nachfolgend wird dieser Ansatz exemplarisch entlang des Onlinekurses Mit Emma durch den Datendschungel vorgestellt. Ziel ist es, Wissen über den Umgang mit Daten in Form einer digitalen Geschichte zu vermitteln, um langfristig den Erwerb von Data-Literacy-Skills zu fördern.'
author: 
  - "Pia Gausling"
  - "Yvonne Erhardt"
image:  "swirls.png"
...
::: {.column-margin}
![Bild 1: Ida Groß - CC BY-NC-ND](1_Illustration.png)
...
::: {.column-margin}
![Grafik 2. Urheberin: Ida Groß CC BY-NC-ND](2_Illustration.png)
...
::: {.column-margin}
![Grafik 3. Urheberin: Ida Groß CC BY-NC-ND](3_Icon.png)
...
::: {.column-margin}
![Grafik 4. Urheberin: Ida Groß CC BY-NC-ND](4_Illustration.png)
...
Die zu transportierenden Inhalte innerhalb der Story orientieren sich an vorab definierten Lernzielen, die sich aus dem Kompetenzrahmen nach Bush et al. [-@bush2021] und dem Data Life Cycle ableiten lassen. Folgende Themenschwerpunkte werden unter anderem berücksichtigt:   
